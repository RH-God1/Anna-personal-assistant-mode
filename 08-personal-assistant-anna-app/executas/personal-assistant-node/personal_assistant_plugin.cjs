...
const PARAMETER_DESCRIPTIONS = {
  ...
  provider: "Preferred provider adapter. Current structured travel booking backend only enables duffel; official-handoff is allowed only when the user explicitly asks for official website/browser handoff.",
