 ...
 *   MANIFEST.name, package.json `bin`, and executa.json `tool_id` MUST equal
 *   the tool_id minted at https://anna.partners/executa.
 */
...
const MANIFEST = {
  ...
  display_name: "Bilingual Focus Session",
  version: "1.0.0",
  description:
...
// State persistence
// ---------------------------------------------------------------------------
const STATE_FILE = process.env.FOCUS_FLOW_STATE_FILE ||
  path.join(os.homedir(), ".anna", "bilingual-focus-flow", "state.json");
